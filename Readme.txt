...
5. Now in the opened diagram, right-click at any space, and one new popup menu will be open. 
6. Now from the open menu, please select the Update model from the database.

After performing all above steps, we can run the project.